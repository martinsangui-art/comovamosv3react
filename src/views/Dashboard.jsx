...
function StatCard({ label, value, color, sub, delay = 0 }) {
  return (
    <div className="animate-fadeUp" style={{
      animationDelay: `${delay}ms`, background: '#fff',
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '220px 1fr', gap: 16, alignItems: 'start' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: 12 }}>
          ...
          <StatCard label="Sin avance" value={stats.sinAv || '—'} sub="vs sem. anterior" color="#7c3aed" delay={180} />
        </div>
      </div>

      {/* Evolución + Top crecimiento */}
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 260px', gap: 16 }}>
        ...
        <div className="animate-fadeUp" style={{
          ...
          <div style={{ fontSize: 13, fontWeight: 600, color: '#0f172a', marginBottom: 2 }}>Evolución semanal</div>
          <div style={{ fontSize: 11, color: '#94a3b8', marginBottom: 16 }}>Cumplimiento global acumulado por corte</div>
          {evolucion.length >= 2 ? (
        ...
        {/* Top crecimiento esta semana */}
        <div className="animate-fadeUp" style={{
          background: '#fff', border: '1px solid #e2e8f0', borderRadius: 16,
          padding: '20px', animationDelay: '120ms',
        }}>
          <div style={{ fontSize: 13, fontWeight: 600, color: '#0f172a', marginBottom: 2 }}>Mayor crecimiento</div>
              ...
              {topCrecimiento.map((d, i) => {
                ...
                return (
                  <div key={d.cod_sede} style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <span style={{
                      width: 20, height: 20, borderRadius: '50%', background: i === 0 ? '#1B2A6B' : '#f1f5f9',
                    ...
                    <span style={{ fontSize: 12, fontWeight: 700, color: '#059669' }}>+{d.var}</span>
                  </div>
                )
              })}
            </div>

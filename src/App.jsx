  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
        ...
        {fecha && (
          <div style={{ padding: '6px 14px', borderRadius: 8, background: '#f8fafc', border: '1px solid #e2e8f0', fontSize: 12, color: '#64748b' }}>
            Corte {fecha}
          </div>
        )}
        {sedes !== undefined && (
          <div style={{ padding: '6px 14px', borderRadius: 8, background: '#eef0f8', border: '1px solid #b8c0e0', fontSize: 12, fontWeight: 600, color: '#1B2A6B' }}>
            {sedes} sedes
          </div>
        )}
        {children}
